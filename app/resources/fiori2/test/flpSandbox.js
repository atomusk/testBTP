		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CreateaSalesOrder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CreateaSalesOrder-display": {
								"semanticObject": "CreateaSalesOrder",
								"action": "display",
								"description": "Create a new temp sales order",
								"title": "Create a Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app_abn-fiori2",
